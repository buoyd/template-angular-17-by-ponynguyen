...
@Component({
  ...
  template: `<main>
      ...
      <nav x-data="{ isOpen: false }" class="container mx-auto p-6 lg:flex lg:items-center lg:justify-between">
        ...
        >
          <div class="flex flex-col space-y-4 lg:mt-0 lg:flex-row lg:space-y-0">
            <a class="text-gray-700 hover:text-blue-500 dark:text-gray-200 dark:hover:text-blue-400 lg:mx-6" href="#"
              >Home</a
            >
            <a class="text-gray-700 hover:text-blue-500 dark:text-gray-200 dark:hover:text-blue-400 lg:mx-6" href="#"
              >Components</a
          ...
          <a
            class="mt-4 block h-10 transform rounded-md border px-5 py-2 text-center text-sm capitalize text-gray-700 transition-colors duration-300 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 lg:mt-0 lg:w-auto"
    ...
    <section class="bg-white dark:bg-gray-900">
      <div class="container mx-auto px-6 pt-28">
        ...
        <div class="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 xl:mt-16 xl:grid-cols-4">
          <div
            class="group flex transform cursor-pointer flex-col items-center rounded-xl p-8 transition-colors duration-300 hover:bg-blue-600"
          >
            <img
      ...
      <div class="container mx-auto px-6 pt-28">
        <div class="mt-6 md:flex md:items-center md:justify-between">
          ...
          <div class="mt-8 flex justify-between md:mt-0">
            <button
              title="left arrow"
              class="mx-3 rounded-full border p-2 text-gray-800 transition-colors duration-300 hover:bg-gray-100 rtl:-scale-x-100 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6"
            ...
            <button
              title="right arrow"
              class="rounded-full border p-2 text-gray-800 transition-colors duration-300 hover:bg-gray-100 rtl:-scale-x-100 dark:border-gray-700 dark:text-gray-200 dark:hover:bg-gray-800"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6"
        ...
        <div class="xl:-mx-8 xl:flex xl:items-center">
          <div class="flex flex-col items-center xl:mx-8 xl:items-start">
            ...
            >
              ...
              <svg
                class="mx-1 h-4 w-4 rtl:-scale-x-100"
                fill="currentColor"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
              >
            ...
            <div class="mt-8 space-y-8 md:-mx-4 md:flex md:items-center md:justify-center md:space-y-0 xl:mt-0">
              <div class="mx-auto max-w-sm rounded-lg border dark:border-gray-700 md:mx-4">
                <div class="p-6">
                  ...
                  <h2 class="mt-4 text-2xl font-medium text-gray-700 dark:text-gray-300 sm:text-4xl">
                    $3.00
                ...
                <div class="p-6">
                  <h1 class="text-lg font-medium capitalize text-gray-700 dark:text-white lg:text-xl">
                    What’s included:
                  </h1>
    ...
    <section class="min-h-screen bg-white dark:bg-gray-900 lg:flex">
      <div
        class="flex w-full flex-col justify-center p-8 lg:w-1/2 lg:bg-gray-100 lg:px-12 lg:dark:bg-gray-800 xl:px-32"
      >
